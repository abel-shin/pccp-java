...
int sum = 0
for (int i = 0; i < array.length; i++) { // 배열의 길이에 비례해서 반복하는 for문
    sum += array[i]
}
```
...
![리스트 개체 삽입](img/section6/1.png)

## Asymptotic Notations

![리스트 개체 삽입](img/section6/2.png)
